...
const JobDetails = () => {
  ...
  const handleApplyClick = () => {
    ...
    setApplicantName(userProfile?.displayName || user.displayName || "");
  ...
  return (
    <div className="min-h-screen" style={{ background: "#f8fafc" }}>
      ...
      <div
        style={{
          background:
            "linear-gradient(135deg, #1e3a8a 0%, #3575E2 60%, #60a5fa 100%)",
        }}
      ...
      >
        <div className="max-w-5xl mx-auto">
          <div className="flex justify-between items-center mb-6">
            ...
            <button
              onClick={handleSave}
              className="flex items-center gap-2 text-white bg-white/10 hover:bg-white/20 px-4 py-2 rounded-xl transition-colors text-sm font-medium"
            >
              <FiBookmark
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
            ...
            <div className="text-white flex-1">
              ...
              <div className="flex flex-wrap gap-x-6 gap-y-2 text-sm text-blue-100">
                ...
                <span className="flex items-center gap-1.5">
                  <FiDollarSign className="flex-shrink-0" />₹{job.minPrice}–
                  {job.maxPrice} LPA {job.salaryType && `(${job.salaryType})`}
                </span>
                <span className="flex items-center gap-1.5">
              ...
              <>
                ...
                {isAdmin ? null : job.status === "closed" ? (
                  ...
                  <button
                    ...
                    style={{
                      background: "linear-gradient(135deg, #3575E2, #5b8dee)",
                    }}
                  >
                    Apply Now
                  </button>
                )}
                {!user && job.status !== "closed" && (
            ...
            <div className="space-y-4">
              {[
                ...
                },
                {
                  ...
                  iconColor: "#16a34a",
                  label: "Salary",
                  value: `₹${job.minPrice}–${job.maxPrice} LPA`,
                },
                {
                  icon: <FiClock />,
                  color: "#faf5ff",
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            ...
            <div className="grid grid-cols-4 gap-3">
              <button
                ...
                className="flex flex-col items-center justify-center py-3 px-1 rounded-xl transition-colors group"
